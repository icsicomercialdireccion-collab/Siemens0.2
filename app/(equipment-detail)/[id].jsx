...
export default function EquipmentDetailScreen() {
  ...
  const { getEquipment, deleteEquipment, updateEquipment, loading } =
    useEquipment();
  ...
  if (!equipment) {
    return (
      <View style={PcDetailStyle.centered}>
        ...
        <TouchableOpacity
          style={PcDetailStyle.backButton}
          onPress={() => router.back()}
        >
  ...
  return (
    <ScrollView style={PcDetailStyle.container}>
      ...
      <View style={PcDetailStyle.header}>
        ...
        <View
          style={[
            PcDetailStyle.statusBadge,
            { backgroundColor: getStatusColor(equipment.estado) },
          ]}
        >
          <Text style={PcDetailStyle.statusText}>
      ...
      {equipment.imagenUrl ? (
        <View style={PcDetailStyle.imageContainer}>
          ...
          <View style={PcDetailStyle.imageOverlay}>
            <Text style={PcDetailStyle.imageCaption}>
      ...
      <View style={PcDetailStyle.infoContainer}>
        <Text style={PcDetailStyle.sectionTitle}>
            ...
            <View style={PcDetailStyle.observationsContainer}>
              <View style={PcDetailStyle.observationsHeader}>
                <Ionicons
                  ...
                  color={COLORS.primary}
                />
                <Text style={PcDetailStyle.observationsTitle}>
                  Observaciones:
                </Text>
              </View>
      ...
      >
        ...
        <Text style={PcDetailStyle.backButtonFullText}>
